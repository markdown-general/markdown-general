...
**Documentation:** `~/markdown-general/intake/ghc-mcp/`
...
**See:** `~/markdown-general/intake/ghc-mcp-pollution/STDOUT-POLLUTION-FIX.md`
...
**See:** `~/markdown-general/intake/ghc-mcp/MCP-CONTENT-UPDATE.md`
