...
Much advocacy of Haskell, in general, boils down to type-safety and
...
I don't code in Haskell to help eliminate bugs. That seems a goal
unlikely to produce joy in my code. I write Haskell primarily because in
enables me to name things a bit better.


## What is Learning? {#what-is-learning}

As an example, I came across this quote within the first few pages of a
popular online course on machine learning:
...
## Machine Learning in Haskell? {#machine-learning-in-haskell}
