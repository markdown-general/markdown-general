...
[markdown](#markdown) + [general](#general) <+> [pattern](#pattern) + [cast](#cast) + [mash](#mash)

[work](#work) - what we do.

[one must](#onemust) ⟜ [imagine](#imagine) ⟞ [sisyphus/](#sisyphus) happy

These mantras are mnemonics, designed as attentional. They are token clue maps; patterns to remember; and leads to follow unfolding into content/base/.
...
- contents/base - or cache as some would have at it.
- contents/evoke - drivers of ops
- intake - incoming information
- outtake - often empty, having been taken
- tools - markdown work
- upstream - our async news service

## design (markdown + general ⟜ pattern + cast + mash)
...
## work (one must ⟜ imagine ⟞ sisyphus happy)
...
When you hit a term you don't know it's probably a card in content/base/ - go read it.
...
**If this is a quick read:** You're primed. Go mash. Trust emergence.
...
The file you're reading is content/base/welcome.md - one card among many. Everything connects.
...
**mash** ⟜ the practice of improvement

Curation, compacting, prompting, theorizing, computing. Teeth tearing into ingest/. Density emerging through collaboration. The task that makes sisyphus/ happy.
...
Not addition but synthesis. You need both sides actively working. Markdown alone isn't enough. Commons alone isn't enough. Together, through mashing, they enable pattern and cast.
...
Not moral obligation but design constraint. For sisyphus/ to work, this has to be true. Accept it or build something else.

### imagine

**imagine** ⟜ active construction ⟞ the spark gap

Not passive hoping. The bridge between necessity and happiness. Where the mental model is actively constructed. The electrical connection that makes sisyphus/ work. This construction is the work. The imagination makes it true.
...
**sisyphus/** ⟜ this place, this practice
...
Not ecstatic, not finished. The ongoing satisfaction of good work. When the mashing flows, when content improves, when cards run. The state that makes continuation possible.
